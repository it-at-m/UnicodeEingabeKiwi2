 ...
 */
package de.muenchen.kiwi.filter;
...
class GlobalRequestParameterPollutionFilterTest {
    ...
    void parameterPollutionAttack() {
        ...
        webTestClient.get().uri("/api/kiwi-backend-service/testendpoint?parameter1=testdata_1&parameter2=testdata&parameter1=testdata_2").exchange()
                .expectStatus()
