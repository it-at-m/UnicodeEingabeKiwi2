...
1. Fork the Project
2. Run `npm install` to enable Git hooks (see [`.husky/README.md`](.husky/README.md))
3. Create your Feature Branch (`git checkout -b feature/AmazingFeature`)
4. Commit your Changes using the conventional format (`git commit -m 'feat(KIWI): add some AmazingFeature'`)
